                ...
                <section className="px-5 lg:px-0">
                    <div className="flex flex-col items-center justify-center mx-auto">
                        <a href="#" className="flex flex-col items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                            <img className="h-32 mr-2 " src="https://i.postimg.cc/ZKrBLCVn/f1cf8db05af92a6ad890383e52c3b423.jpg" alt="logo" />
                        </a>
                            ...
                            <div className="p-2 space-y-4 lg:p-6 md:space-y-6 sm:p-8">
                                ...
                                <form onSubmit={handelLogin} className="space-y-4 md:space-y-6" >
                                    ...
                                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                        Don't have an account? <Link to='/registration' className="font-medium text-primary-600 hover:underline dark:text-primary-500">Registration</Link>
                                    </p>
                                </form>
                            </div>
                        </div>
